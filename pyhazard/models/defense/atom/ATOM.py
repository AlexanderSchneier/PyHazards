...
from pyhazard.datasets.datasets import Dataset as PyHazardDataset
from pyhazard.models.defense.base import BaseDefense
from pyhazard.utils.metrics import DefenseMetric, DefenseCompMetric
...
class ATOM(BaseDefense):
    ...
    def __init__(self, dataset: PyHazardDataset, attack_node_fraction: float = 0):
